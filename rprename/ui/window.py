...
class Ui_Window(object):
    ...
    def retranslateUi(self, Window):
        ...
        Window.setWindowTitle(_translate("Window", "Redenumire Fisiere"))
        self.label.setText(_translate("Window", "Ultimul director sursa:"))
        self.loadFilesButton.setText(_translate("Window", "&Incarca Fisiere"))
        self.label_2.setText(_translate("Window", "Fisiere pentru redenumit"))
        self.label_3.setText(_translate("Window", "Fisiere redenumite"))
        self.label_4.setText(_translate("Window", "Filename Prefix:"))
        self.prefixEdit.setPlaceholderText(
            _translate("Window", "Redenumeste fisierele in...")
        )
        self.extensionLabel.setText(_translate("Window", "*.jpg"))
        self.renameFilesButton.setText(_translate("Window", "&Redenumeste"))
